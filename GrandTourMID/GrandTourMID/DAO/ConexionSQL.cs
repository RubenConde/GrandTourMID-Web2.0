...
namespace GrandTourMID.DAO
{
    public class ConexionSQL
    {
        ...
        public ConexionSQL()
        {
            con = new SqlConnection("Server=DESKTOP-FVBST9M;Database=proyectoTour;Trusted_Connection=True");
        ...
        {
            string cs = "Server=DESKTOP-FVBST9M;Database=proyectoTour;Trusted_Connection=True";
