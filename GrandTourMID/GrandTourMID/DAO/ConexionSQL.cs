...
namespace GrandTourMID.DAO
{
    public class ConexionSQL
    {
        ...
        public ConexionSQL()
        {
            con = new SqlConnection("Server=DESKTOP-9IRF3BO;Database=proyectoTour;Trusted_Connection=True;");
        ...
        {
            string cs = "Server=DESKTOP-9IRF3BO;Database=proyectoTour;Trusted_Connection=True;";
